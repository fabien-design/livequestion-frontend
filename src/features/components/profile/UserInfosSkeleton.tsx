...
export default function UserInfosSkeleton() {
    return (
        <div>
            ...
            <div className="md:flex md:justify-evenly">
                ...
                <div className="flex gap-2 justify-center items-center">Email: <Skeleton className="ml-2 w-[150px] h-[20px] bg-gray-300"></Skeleton></div>
